...
class Parameters():
	def __init__(self):
		# TODO: Adjust the num_workers to utilize CPU
		self.n_processors = 32
		# Path
		self.data_dir =  '/home/dl/DeepVO-pytorch/KITTI'
		self.image_dir = self.data_dir + '/images/'
		self.pose_dir = self.data_dir + '/pose_GT/'
		self.velo_dir = self.data_dir + '/velodynes/'
		...
		# TODO: Calculate the means and stds of customized dataset
		...
		self.minus_point_5 = True # NOTICE: minus_point_5

		self.seq_len = (2, 2) # NOTICE: seq_len: default (5, 7)
		self.sample_times = 1	# default 3
